            ...
            <div class="card-body">
                ...
                <form action="{{ route('guest.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="check_in" placeholder="Chech-In" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="no_tel" placeholder="Masukkan No Telepon" required>
                    </div>
                    {{-- @dd($categories) sama kaya fungsi vardump --}}
                    <div class="mb-3">
                        <label for="" class="form-label">Status Tamu *</label>
                        <select type="text" class="form-control" name="status_tamu" placeholder="Status Tamu" required>
                            <option value="">--Pilih No--</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea  class="form-control" rows="10" cols="30" name="alamat" placeholder="Masukkan Alamat" required></textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" style="display:none" name="kebutuhan_khusus" id="kebutuhan_khusus" >
                    </div>
                    <script>
